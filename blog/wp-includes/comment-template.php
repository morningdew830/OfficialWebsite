		...
		<?php if ( comments_open( $post_id ) ) : ?>
			...
			<div id="respond" class="comment-respond">
				<?php if ( get_option( 'comment_registration' ) && !is_user_logged_in() ) : ?>
					...
					?>
				<?php else : ?>
					<form action="<?php echo site_url( '/wp-comments-post.php' ); ?>" method="post" id="<?php echo esc_attr( $args['id_form'] ); ?>" class="comment-form form-brg"<?php echo $html5 ? ' novalidate' : ''; ?>>
						<h3 id="reply-title" class="comment-reply-title leave-comment"><?php comment_form_title( $args['title_reply'], $args['title_reply_to'] ); ?> <small><?php cancel_comment_reply_link( $args['cancel_reply_link'] ); ?></small></h3>
